...
function getNumberOfLinesInContainer(container: HTMLElement): number {
...
const myOutput2 = document.getElementById('myOutput');
const numberOfLines = getNumberOfLinesInContainer(myOutput);
console.log(`Number of lines in the container: ${numberOfLines}`);
